# YOLOv11 Food Detection System

## Body

YOLOv11 Food Detection System Based on Deep Learning YOLOv11, Food Detection System (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)
...
Dataset quantity: training set 12802 images, validation set 1220 images, test set 639 images.
